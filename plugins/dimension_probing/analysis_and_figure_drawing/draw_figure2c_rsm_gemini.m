...
colormap(viridis)
hold on
text(24,-4,'Predicted MLLM RSM','HorizontalAlignment','center','FontSize',14);
...
text(24,-4,'Measured MLLM RSM','HorizontalAlignment','center','FontSize',14);
colormap(viridis)
axis off square tight
...
plot(squareformq(spose_sim48),squareformq(1-RDM48_triplet),'o','MarkerFaceColor',[.6 .2 .4],'MarkerEdgeColor','none','MarkerSize',3);
...
if dosave
    saveas(h, 'rsm_compare_gemini.pdf', 'pdf');
end
