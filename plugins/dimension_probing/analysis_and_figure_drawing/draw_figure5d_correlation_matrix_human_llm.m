...
ylabel('Human dimensions', 'FontSize', 14);
xlabel('LLM dimensions', 'FontSize', 14);
exportgraphics(fig, 'figures/reordered_corr_matrix_llm_human.pdf', 'ContentType', 'vector');
close(fig);
...
doprint = 1;
if doprint
print(gcf,'-dpdf','figures/figure_river_llm_human.pdf','-bestfit') 
end