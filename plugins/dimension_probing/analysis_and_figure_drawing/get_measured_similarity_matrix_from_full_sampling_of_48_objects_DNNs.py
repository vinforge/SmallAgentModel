...
model_sets = ['CLIPvison_ViT_L14', 'CLIPtext_ViT_L14', 'gabor', 'vgg16','resnet18','cornet_s','alexnet']
num_objects = 1854
for model in model_sets:
    print("model name:", model)
    with open('data/DNNs/' + model + '/triplet_dataset/full_sampling_for_48_objects.txt', 'r') as file:
    ...
    sio.savemat('data/DNNs/' + model + '/RSM1854_get_from_full_sampling_of_48_objects_' + model + '.mat',
                {'RSM1854_triplet': similarity_matrix_full})
    sio.savemat('data/DNNs/' + model + '/RSM1854_get_from_full_sampling_of_48_objects_' + model + '_splithalf.mat',
