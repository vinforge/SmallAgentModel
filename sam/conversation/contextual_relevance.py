...
class ContextualRelevanceEngine:
    ...
    def _sam_vector_similarity(self, text1: str, text2: str) -> float:
        ...
        try:
            # Use SAM's embedding utilities for proper vector similarity
            ...
            embedding1 = embedding_manager.embed(text1)
            embedding2 = embedding_manager.embed(text2)
...
Title:"""
    ...
    def _generate_embedding_summary(self, conversation_buffer: List[Dict[str, Any]]) -> Optional[List[float]]:
        ...
        try:
            ...
            if self.embedding_system == 'sam_vectorstore':
                # Use SAM's embedding utilities
                from utils.embedding_utils import get_embedding_manager
                embedding_manager = get_embedding_manager()
                embedding = embedding_manager.embed(content_text)
